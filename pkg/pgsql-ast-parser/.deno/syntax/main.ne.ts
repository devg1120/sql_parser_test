...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "altertype_statement$subexpression$1", "symbols": ["altertype_enum_owner"]},
    ...
    {"name": "altertype_enum_owner", "symbols": ["kw_owner", (lexerAny.has("kw_to") ? {type: "kw_to"} : kw_to), "word"], "postprocess":  x => track(x, {
            type: 'alter enum',
            change: {
              type: 'owner',
              to: asName(last(x))
