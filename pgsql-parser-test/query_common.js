...
export function print_json(stmts) {
  if (P) {
...
export function stmt_filter(array, filters) {
  let stmts = [];
  for (let i in array) {
...
export function stmt_print(array) {
  for (let i in array) {
    for (let key in array[i]["stmt"]) {
...
export function walk(element, indent) {
  let base = "    ";
