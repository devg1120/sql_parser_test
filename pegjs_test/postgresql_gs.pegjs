...
func_block  /*GUSA*/
  = "AS $_$" (!"$_$" !"AS $_$" char / func_block)* "$_$"
  / "AS $$" (!"$$" !"AS $$" char / func_block)* "$$"

create_func_opt  /*GUSA*/
  = 'LANGUAGE' __ ln:ident_name __ 'IMMUTABLE'? __ 'STRICT'? __ 'SECURITY'? __  'DEFINER'?  __ func_block {
    // => literal_string
    return {
      prefix: 'LANGUAGE',
      type: 'default',
...
//ident_name = 'public.'? ident_name_         /* GUSA */
